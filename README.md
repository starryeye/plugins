...
- Release: [`v0.5.0`](https://github.com/starryeye/web-translator/releases/tag/v0.5.0)
...
```powershell
py -3.11 -m venv .venv
& .\.venv\Scripts\python.exe -m pip install "web-translator[test] @ git+https://github.com/starryeye/web-translator.git@v0.5.0"
...
./.venv/bin/python -m pip install "web-translator[test] @ git+https://github.com/starryeye/web-translator.git@v0.5.0"
